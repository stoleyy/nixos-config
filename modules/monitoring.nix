...
in
{
  ...
  systemd.services = {
    ...
    "wg-quick-protonvpn".unitConfig.OnFailure = "ntfy-failure@%n.service";
    "dnscrypt-proxy".unitConfig.OnFailure = "ntfy-failure@%n.service";
    "suricata".unitConfig.OnFailure = "ntfy-failure@%n.service";
    "crowdsec".unitConfig.OnFailure = "ntfy-failure@%n.service";
    ...
    vector.serviceConfig = lib.mkIf config.services.vector.enable {
